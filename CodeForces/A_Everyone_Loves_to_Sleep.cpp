...
void solve()
{
   ll n;
   pair<ll,ll> hours;
   cin>>n>>hours.first>>hours.second;
   set<pair<ll,ll>> nums;
   for(ll x=0; x<n; x++)
    {
        ll a,b;
    ...
    set<pair<ll,ll>>::iterator it = nums.lower_bound(hours);
    ...
    a=comp.first-hours.first;
    if(hours.second> comp.second)
    {
        b= comp.second+60-hours.second;
        a--;
    }
    else b=comp.second-hours.second;
